...
module.exports = {
    ...
    PLKIMG: process.env.LIST_IMG === undefined ? 'https://www.linkpicture.com/q/Tony-Ser.jpg' : process.env.LIST_IMG,
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://i.imgur.com/nErXUGj.mp4' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/Z1jCYGN.mp4' : process.env.GIF_BYE,
    BOTPLK: process.env.BOT_NAME === undefined ? 'TONY SER' : process.env.BOT_NAME,
